...
<details>
  ...
  |동네예보조회|**getVilageFcst**|X좌표, Y좌표, 발표시각|-|
  |초단기예보조회|**getUltraSrtFcst**|X좌표, Y좌표, 발표시각|-|
  |초단기실황조회|**getUltraSrtNcst**|X좌표, Y좌표, 발표시각|-|
  ...
  * 동네예보 통보문은 모두 일 3회 (5시, 11시, 17시) 발표되며 조회시간 기준 최근 통보문만 조회됩니다.  
...
|특보코드조회|**getPwnCd**|지점번호, 시작날짜, 종료날짜,<br>특보구역코드, 특보종류|1:강풍, 2:호우, 3:한파, 4:건조, 5:폭풍해일,<br>6:풍랑, 7:태풍, 8:대설, 9:황사, 12:폭염|
|특보현황조회|**getPwnStatus**| - |-|
